...
**This is the Render-hosted variant of Syncify.**  
If you want the original Windows/local-host version, switch to the [windows](https://github.com/jnandevupadhya/syncify/tree/windows) branch.

## 🚀 Live Demo (No Setup Needed)

If you just want to see how Syncify works before setting anything up:

**Live Demo:** https://test-syncify.onrender.com/

No install needed, just open the page and try it out.
...
You’ll need a **Spotify Premium** (since Spotify only allows playback control for Premium users) account.
