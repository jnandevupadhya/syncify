  ...
  return (
    ...
    >
      <div className=" flex gap-12 w-full mx-auto slide-up-enter -translate-y-1/4">
        ...
        <div
          className={` crafty absolute top-[25vh] translate-x-[5vw] -translate-y-1/2 w-1/4 max-w-sm z-10 transition-opacity duration-300 ${
        ...
        <div className="flex -translate-y-[20px] flex-col w-full items-center">
          ...
          <div className="flex-1 text-center max-h-[365px] pt-0 relative">
            ...
            <div
              ...
              style={{ paddingTop: showDiv ? 50 : 40 }}
            >
              ...
              <div className="flex flex-col  items-center justify-center text-center relative">
                ...
                >
                  <div className="text-7xl mt-0 z-999 mb-6 animate-bounce">
                    🎉
                  </div>
            ...
            <div
              className={`transition-all duration-500 ease-in-out overflow-hidden ${
                !showDiv
                  ? "opacity-100 max-h-[30.04vh] mt-[2.96vh]"
                  : "opacity-0 max-h-0 mt-0"
              }`}
            >
              {
          ...
          <div
            className={` absolute right-0 top-[25vh] translate-x-[-5vw] -translate-y-1/2 w-1/4 max-w-sm z-10 transition-opacity duration-300 ${
              !showDiv ? "opacity-100" : "opacity-0"
            }`}
          >
